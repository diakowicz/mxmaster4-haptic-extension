...
Click events in browser windows (Chrome, Edge, Firefox, Brave, Opera, Vivaldi, Arc, Zen, Chromium, Thorium) are excluded to avoid doubling up with the browser extension.
